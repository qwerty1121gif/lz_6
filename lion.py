...
words = pd.Series(re.findall(r'\b\w+\b', text)).value_counts()
df_words = words.rename_axis('Слово').reset_index(name='Частота')
df_words['Процент'] = (df_words['Частота'] / len(words)) * 100
print(df_words)
